...
app = FastAPI(
    ...
    servers=[
        {"url": "https://institutes-senior-fears-webshots.trycloudflare.com"}
    ]
)
...
@app.get(
        ...
        description="Upon receiving a GET request this endpoint will return a real\
            quote said by Nicolacus Maximus himself.",
        response_description="A Quote object that contains the quote said by\
            Nicolacus Maximus and the date when the quote was said.",
